...
class OnnxDecoder:
    def __init__(self, model_path):
        ...
        print("ONNX CPU decoder loaded:", model_path)
        print("decoder inputs:", self.input_names)
        print("decoder outputs:", self.output_names)

    def inference(self, inputs):
        z_p_slice, g = inputs
        feed = {
            self.input_names[0]: z_p_slice,
            self.input_names[1]: g,
        }
...
def get_args():
    ...
    parser.add_argument("--decoder", "-d", type=str, required=False, default="decoder.onnx")
...
def main():
    ...
    # 初始化RKNNLite
    # CPU decoder: use decoder.onnx with ONNX Runtime
    decoder = OnnxDecoder(dec_model)
